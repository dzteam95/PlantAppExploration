...
const GardenT = ({route, navigation, props}) => {
  ...
  searchUserReminderFunction = async () => {
    ...
    let tokenLocal =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2MGJkY2JhNDI0NWQxZjBiMDE0NDJlMjIiLCJpYXQiOjE2MjQ3OTMwNTgsImV4cCI6MTYyNTM5Nzg1OH0.YAPsZ4WWgGF7BNbQ6Kwt5Om7gQX2NEgkC77JDMjk7-g';
