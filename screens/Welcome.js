    ...
    <ImageBackground source={Bg} style={styles.image}>
      <View style={styles.containerGlobal}>
        <Text style={styles.title}>
          Voici <Text style={styles.seedy}> Seedy</Text>, le conseiller en
          jardinage pour ne plus se prendre la tête{' '}
        </Text>
        ...
        <TouchableOpacity onPress={() => navigation.replace('Register')}>
          <Text style={styles.txt}>
            Déja convaincu?<Text style={styles.link}> m'inscrire</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </ImageBackground>
